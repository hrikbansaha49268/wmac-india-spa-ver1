...
const TestCom = ({ element }) => {
    return (
        <div className="relative mx-auto group m-8 flex overflow-y-hidden">
            ...
            />
            <div className={`absolute h-full translate-y-full mt-60 group-hover:mt-0 group-hover:translate-y-[40%] top-0 p-6 duration-300 ease-in-out rounded-lg ${element.bgColor}`}>
